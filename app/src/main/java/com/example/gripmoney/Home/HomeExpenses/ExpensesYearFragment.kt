...
class ExpensesYearFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        myFragment = inflater.inflate(R.layout.fragment_expenses_year, container, false)
    ...
    private fun getExpenses(){
        ...
        val collections = db.collection(user.toString()).document("expenses")
        var num :Int =1
        for(i in 1..365){
            ...
            addSnapshotListener(object: EventListener<QuerySnapshot> {
                override fun onEvent(
                    ...
                    for(dc: DocumentChange in value?.documentChanges!!){
                        ...
                        editor.putString("YearAmounts", jsonA)
                        editor.putString("YearCategories", jsonC)
                        editor.apply()
                    }
