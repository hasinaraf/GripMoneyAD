...
class IncomeMonthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        myFragment = inflater.inflate(R.layout.fragment_income_month, container, false)
            ...
            addSnapshotListener(object: EventListener<QuerySnapshot> {
                override fun onEvent(
                    ...
                    for(dc: DocumentChange in value?.documentChanges!!){
                        ...
                        editor.putString("MonthInAmounts", jsonA)
                        editor.putString("MonthInCategories", jsonC)
                        editor.apply()
                    }
