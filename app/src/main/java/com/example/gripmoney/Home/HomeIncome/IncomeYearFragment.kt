...
class IncomeYearFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        myFragment = inflater.inflate(R.layout.fragment_income_year, container, false)
    ...
    private fun getIncome(){
        ...
        val collections = db.collection(user.toString()).document("Income")
        var num :Int =1
        for(i in 1..365){
            ...
            addSnapshotListener(object: EventListener<QuerySnapshot> {
                override fun onEvent(
                    ...
                    for(dc: DocumentChange in value?.documentChanges!!){
                        ...
                        editor.putString("YearInAmounts", jsonA)
                        editor.putString("YearInCategories", jsonC)
                        editor.apply()
                    }
