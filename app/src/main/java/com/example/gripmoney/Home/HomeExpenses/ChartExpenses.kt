...
class ChartExpenses : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar!!.title="My Expenses Chart"
        amounts = arrayListOf()
        categories = arrayListOf()
        chart = findViewById(R.id.ac_ed_pc)
        ...
        if(choose == "day"){
            typeAmo = "DayAmounts"
            typeCat = "DayCategories"
        }else if(choose == "week"){
            typeAmo = "WeekAmounts"
            typeCat = "WeekCategories"
        }else if(choose == "month"){
            typeAmo = "MonthAmounts"
            typeCat = "MonthCategories"
        }else {
            typeAmo = "YearAmounts"
            typeCat = "YearCategories"
        }
    ...
    fun configChartView(amounts:ArrayList<String>, categories:ArrayList<String>, type:String){
        ...
        pie.title("Expenses per ${type} Overview")
        chart.setChart(pie)
    }
