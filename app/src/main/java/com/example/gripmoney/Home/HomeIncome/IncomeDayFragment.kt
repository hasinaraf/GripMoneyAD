...
class IncomeDayFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        myFragment = inflater.inflate(R.layout.fragment_income_day, container, false)
    ...
    private fun getIncome(){
        ...
        db.collection(user.toString()).document("income").collection(currentDate.toString()).
        addSnapshotListener(object: EventListener<QuerySnapshot> {
            override fun onEvent(
                ...
                for(dc: DocumentChange in value?.documentChanges!!){
                    ...
                    editor.putString("DayInAmounts", jsonA)
                    editor.putString("DayInCategories", jsonC)
                    editor.apply()
                }
