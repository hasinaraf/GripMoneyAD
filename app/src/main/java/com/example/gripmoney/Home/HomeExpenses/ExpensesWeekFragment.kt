...
class ExpensesWeekFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        myFragment = inflater.inflate(R.layout.fragment_expenses_week, container, false)
        ...
        addSnapshotListener(object: EventListener<QuerySnapshot> {
            override fun onEvent(
                ...
                for(dc: DocumentChange in value?.documentChanges!!){
                    ...
                    editor.putString("WeekAmounts", jsonA)
                    editor.putString("WeekCategories", jsonC)
                    editor.apply()
                }
