...
class TransferWeekFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        myFragment = inflater.inflate(R.layout.fragment_transfer_week, container, false)
            ...
            addSnapshotListener(object: EventListener<QuerySnapshot> {
                override fun onEvent(
                    ...
                    for(dc: DocumentChange in value?.documentChanges!!){
                        ...
                        editor.putString("WeekTrAmounts", jsonA)
                        editor.putString("WeekTrTransaction", jsonC)
                        editor.apply()
                    }
