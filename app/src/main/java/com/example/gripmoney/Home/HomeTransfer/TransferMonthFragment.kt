...
class TransferMonthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        myFragment = inflater.inflate(R.layout.fragment_transfer_month, container, false)
            ...
            addSnapshotListener(object: EventListener<QuerySnapshot> {
                override fun onEvent(
                    ...
                    for(dc: DocumentChange in value?.documentChanges!!){
                        ...
                        editor.putString("MonthTrAmounts", jsonA)
                        editor.putString("MonthTrTransaction", jsonC)
                        editor.apply()
                    }
